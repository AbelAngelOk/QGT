...
const listReports = () => {
  ...
  return (
    <section id='listReports' className='w-full h-auto flex text-xs pb-16 sm:text-base flex-wrap items-center justify-center px-1 py-5 bg-slate-200 dark:bg-slate-700 '>
      <ul id='listReports--table' className='sm:w-11/12 flex flex-wrap rounded-lg shadow-lg bg-slate-300 dark:bg-slate-800 border'>
        <li id='listReports--titleCols' className='p-1 w-full flex flex-wrap'>
          <ul id='listReports--titleCols--inner' className='p-1 w-full flex flex-wrap gap-3 rounded-lg items-center justify-evenly'>
