  ...
  return (
    <section id='simpleBoxes01' className='w-full h-auto flex flex-wrap justify-center pb-[5%] bg-palette-light-bg300 dark:bg-palette-light-txt800'>
      <div id='simpleBoxes01-titleContainer' className='w-full h-auto flex justify-center my-8 mx-0'>
        <h2 id='simpleBoxes01-title' className='py-5 text-4xl md:text-5xl text-palette-light-txt800 dark:text-palette-light-bg100'> {cns.title} </h2>
      </div>
...
const Box = ({ data }) => {
  return (
    <li id={'simpleBoxes01-Box' + data.id} className='flex h-auto md:w-1/6 flex-col rounded-xl pt-0 px-3 pb-3 bg-palette-light-bg200  dark:bg-palette-light-txt700'>
