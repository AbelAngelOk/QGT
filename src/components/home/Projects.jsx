    ...
    <section className='proyectos'>
      <ul className='proyectos--inner'>
        <li className='proyectos--title'>
          <h1> {tituloSeccionProyectos}</h1>
        </li>
        <li className='proyectos--description'>
          <p> {descripcionDeProyectos} </p>
        </li>
